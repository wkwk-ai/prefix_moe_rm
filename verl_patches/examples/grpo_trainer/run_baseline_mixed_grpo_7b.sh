#!/bin/bash
# Baseline: GRPO with mixed data (Ernie-rlhf + MedKgQA) on Qwen2.5-7B-Instruct
...
# ---------- Configuration ----------
ACTOR_MODEL_PATH=/mnt/data/model/Qwen2.5-7B-Instruct
...
# ---------- Launch GRPO (7B model, adjusted params for A100-40GB x 8) ----------
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='qwen2.5_7b_mixed_rule_rm_baseline' \
    ...
    trainer.rollout_data_dir=/home/haowang/prefix_moe_rm/verl/rollout_outputs_7b_baseline \
    trainer.validation_data_dir=/home/haowang/prefix_moe_rm/verl/validation_outputs_7b_baseline \
    trainer.benchmark_data_dir=/home/haowang/prefix_moe_rm/verl/benchmark_outputs_7b_baseline \
